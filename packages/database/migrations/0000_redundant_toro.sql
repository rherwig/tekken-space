...
CREATE TABLE IF NOT EXISTS "moves" (
	...
	"damage_hits" text,
	"damage_total" text,
	"frames_on_block" text,
	"frames_on_counter_hit" text,
	"frames_on_hit" text,
	"frames_on_startup" text,
	"hit_levels" text[] DEFAULT ARRAY[]::text[] NOT NULL,
	"id" varchar(128) PRIMARY KEY NOT NULL,
	...
	"notes" text,
	"properties" text[] DEFAULT ARRAY[]::text[] NOT NULL,
	"updated_at" timestamp
);
--> statement-breakpoint
DO $$ BEGIN
